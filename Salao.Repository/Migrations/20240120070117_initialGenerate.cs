...
namespace Salao.Repository.Migrations
{
    /// <inheritdoc />
    public partial class initialGenerate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GenericPassword = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuRoles", x => new { x.Id, x.MenuId, x.RoleId });
                    table.ForeignKey(
